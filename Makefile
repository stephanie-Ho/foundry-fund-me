...
build:; forge build   # terminal: make build

deploy-sepolia:

	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --account Sepolia --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
